...
def normalise_input(player_input):
    ...
    'help'
    """
    spaces_remove = remove_spaces(player_input)
    punc_remove = remove_punct(spaces_remove)
    return punc_remove.strip().lower()
...
def print_menu_line(direction, leads_to):
    ...
    """
    """for direction_info in exits:
        direction_name = direction(["exits".keys()]).upper()
        lead_to_name = leads_to(["exits"])
        print("GO", direction_name, "to", lead_to_name, ".")
    pass
    """
...
def is_valid_exit(exits, player_input):
